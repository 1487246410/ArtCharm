...
　　同理，当我们点击上一张到0px（这是第五张图片时），我们希望下次跳转到第四张，即-2400px；*/
    ...
    dingwei(".maodian1",'#shougongyi');
    dingwei(".maodian2",'#shufa');
    dingwei(".maodian3",'#huihua');
    dingwei(".maodian4",'#chuangxin');
    dingwei(".maodian5",'#diaosu');
    dingwei(".maodian6",'#shifu');
    dingwei(".maodian7",'#minzugongyi');
    dingwei(".maodian8",'#guwangjinlai');
